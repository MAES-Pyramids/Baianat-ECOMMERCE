...
export abstract class IMutation {
  ...
  ): SetPasswordResponse | Promise<SetPasswordResponse>;

  abstract generateResetPassJWT(
    passResetInput: PassResetInputDto,
  ): PassResetResponse | Promise<PassResetResponse>;
  ...
  ): SendOtpResponse | Promise<SendOtpResponse>;
